...
public interface PGParserVisitor<T> extends ParseTreeVisitor<T>
{
   ...
   * @return the visitor result
   */
  T visitUser_or_role_or_group_common_option(
   ...
   * @return the visitor result
   */
  T visitUser_or_role_or_group_option_for_create(
   ...
   * @return the visitor result
   */
  T visitTokens_nonreserved_except_function_type(
   ...
   * @return the visitor result
   */
  T visitTokens_reserved_except_function_type(
