...
class SqlDataTypeImpl implements SqlDataType
{
  ...
  public int storageSize()
  {
    switch (name)
    {
      ...
      case DataTypeName.YEAR: return 1;
      case DataTypeName.SMALLINT:
      case DataTypeName.SMALLSERIAL: return 2;
      ...
      case DataTypeName.DATE: return 4;
      ...
      case DataTypeName.MONEY: return 8;
      case DataTypeName.TIMETZ: return 12;
      case DataTypeName.INTERVAL:
      case DataTypeName.UUID: return 16;
      case DataTypeName.BIT:
      case DataTypeName.BIT_VARYING: return (width - 1) / 8 + 1;
      ...
      case DataTypeName.FIXED:
        ...
        return 4
            * (numIntegralDigit / 9 + (numIntegralDigit % 9 == 0 ? 0 : 1) + numFractionalDigit / 9
      ...
      case DataTypeName.VARBINARY: return width;

      case DataTypeName.TINYTEXT:
      case DataTypeName.TINYBLOB: return 255;
      case DataTypeName.TEXT:
      case DataTypeName.BLOB: return 65535;
      case DataTypeName.MEDIUMTEXT:
      case DataTypeName.MEDIUMBLOB: return 16777215;
      case DataTypeName.BIGTEXT:
      case DataTypeName.LONGBLOB: return Integer.MAX_VALUE;

      case DataTypeName.JSON:
      case DataTypeName.XML: return 1024;

      case DataTypeName.CIDR:
      case DataTypeName.INET: return 19;
  ...
  public void formatAsCastType(StringBuilder builder, String dbType)
  {
    ...
    { // postgres use same rule for dataType and castType
  ...
  private void formatTypeBody(StringBuilder builder, String dbType)
  {
    ...
    if (intervalField != null)
      builder.append(' ').append(intervalField);
  ...
  public String toString()
  {
    ...
    if (dimensions != null && dimensions.length > 0)
      formatAsDataType(builder, PostgreSQL);
    else
      formatAsDataType(builder, MySQL);
