...
class NormalizeBool
{
  ...
  private static void normalizeExpr(SqlNode expr)
  {
    ...
    assert exprKind == ExprKind.Unary || exprKind == ExprKind.Binary || exprKind == ExprKind.Ternary
        || exprKind == ExprKind.Case || exprKind == ExprKind.Exists || exprKind == ExprKind.Match
        || exprKind == ExprKind.ColRef || exprKind == ExprKind.Literal
