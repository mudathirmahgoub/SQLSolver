...
class MySQLAstBuilder extends MySQLParserBaseVisitor<SqlNode> implements AstBuilderMixin
{
  ...
  public SqlNode visitAlterTable(MySQLParser.AlterTableContext ctx)
  {
    ...
    final List<SqlNode> actions =
        map((Iterable<MySQLParser.AlterListItemContext>) ctx.alterTableActions()
                .alterCommandList()
                .alterList()
                .alterListItem(),
            (Function<? super MySQLParser.AlterListItemContext, ?
                          extends SqlNode>) this::visitAlterListItem);
  ...
  public SqlNode visitAlterListItem(MySQLParser.AlterListItemContext ctx)
  {
    if (ctx.tableConstraintDef() != null)
    {
      ...
      action.$(SqlNodeFields.AlterTableAction_Payload,
          visitTableConstraintDef(ctx.tableConstraintDef()));
      return action;
    }
    else if (ctx.MODIFY_SYMBOL() != null)
    {
      ...
      colName.$(SqlNodeFields.ColName_Col,
          MySQLAstHelper.stringifyIdentifier(ctx.columnInternalRef().identifier()));
  ...
  public SqlNode visitCreateTable(MySQLParser.CreateTableContext ctx)
  {
    ...
    for (var element : ctx.tableElementList().tableElement())
    {
      ...
      if (colDefs != null)
        columnDefs.add(visitColumnDefinition(colDefs));
      else if (consDefs != null)
        constraintDefs.add(visitTableConstraintDef(consDefs));
      else
        return assertFalse();
    }
    ...
    if (tableOptions != null)
      for (var option : tableOptions.createTableOption())
        ...
        {
          node.$(SqlNodeFields.CreateTable_Engine,
              MySQLAstHelper.stringifyText(option.engineRef().textOrIdentifier()));
          break;
        }
  ...
  public SqlNode visitColumnDefinition(MySQLParser.ColumnDefinitionContext ctx)
  {
    ...
    if (checkOrRef != null)
      ...
      else if (checkOrRef.checkConstraint() != null)
        node.flag(SqlNodeFields.ColDef_Cons, CHECK);
  ...
  public SqlNode visitTableConstraintDef(MySQLParser.TableConstraintDefContext ctx)
  {
    ...
    switch (type.getText().toLowerCase())
    {
      ...
      case "index":
        c = null;
        t = Commons.coalesce(MySQLAstHelper.parseIndexKind(indexNameAndType),
            MySQLAstHelper.parseIndexKind(indexOptions));
    ...
    if (keyList != null)
    {
      keys = map((Iterable<MySQLParser.KeyPartContext>) keyList.keyPart(),
          (Function<? super MySQLParser.KeyPartContext, ? extends SqlNode>) this::visitKeyPart);
    }
    else if (keyListVariants != null)
    {
      keys = map(
          (Iterable<MySQLParser.KeyPartOrExpressionContext>) keyListVariants.keyListWithExpression()
              .keyPartOrExpression(),
          (Function<? super MySQLParser.KeyPartOrExpressionContext, ?
                        extends SqlNode>) this::visitKeyPartOrExpression);
    }
    else
    {
      return assertFalse();
    ...
    if (references != null)
      node.$(SqlNodeFields.IndexDef_Refs, visitReferences(references));
  ...
  public SqlNode visitKeyPart(MySQLParser.KeyPartContext ctx)
  {
    ...
    if (ctx.fieldLength() != null)
      node.$(SqlNodeFields.KeyPart_Len, MySQLAstHelper.fieldLength2Int(ctx.fieldLength()));
    return node;
  }
  ...
  {
    if (ctx.keyPart() != null)
      return visitKeyPart(ctx.keyPart());
  ...
  public SqlNode visitQueryExpression(MySQLParser.QueryExpressionContext ctx)
  {
    ...
    if (orderByClause != null)
      query.$(SqlNodeFields.Query_OrderBy, mkNodes(toOrderItems(orderByClause)));
  ...
  public SqlNode visitQueryExpressionBody(MySQLParser.QueryExpressionBodyContext ctx)
  {
    ...
    if (ctx.queryExpressionBody() != null)
    {
      ...
      if (ctx.querySpecification() != null)
        right = ctx.querySpecification().accept(this);
      else
        right = ctx.queryExpressionParens(0).accept(this);
    }
    else if (ctx.queryExpressionParens(0) != null)
    {
      ...
      if (ctx.querySpecification() != null)
        ...
        right = ctx.queryExpressionParens(1).accept(this);
    }
    else
      return assertFalse();

    final SetOpOption option = ctx.unionOption() == null
  ...
  public SqlNode visitQuerySpecification(MySQLParser.QuerySpecificationContext ctx)
  {
    ...
    if (selectItemList.MULT_OPERATOR() != null)
      items.add(mkSelectItem(mkExpr(ExprKind.Wildcard), null));
    ...
    if (fromClause != null)
    {
      ...
      if (from != null)
        node.$(SqlNodeFields.QuerySpec_From, from);
    }

    final var whereClause = ctx.whereClause();
    if (whereClause != null)
      node.$(SqlNodeFields.QuerySpec_Where, toExpr(whereClause.expr()));
    ...
    if (groupByClause != null)
    {
      ...
      if (olapOption != null)
        node.$(SqlNodeFields.QuerySpec_OlapOption, olapOption);
    ...
    if (havingClause != null)
      node.$(SqlNodeFields.QuerySpec_Having, toExpr(havingClause.expr()));

    final var windowClause = ctx.windowClause();
    if (windowClause != null)
      node.$(SqlNodeFields.QuerySpec_Windows,
  ...
  {
    if (ctx.DUAL_SYMBOL() != null)
      return null;

    return ctx.tableReferenceList()
        .tableReference()
        .stream()
  ...
  public SqlNode visitSingleTable(MySQLParser.SingleTableContext ctx)
  {
    ...
    if (ctx.usePartition() != null)
    {
      ...
      node.$(TableSourceFields.Simple_Partition,
          map(identifiers, MySQLAstHelper::stringifyIdentifier));
    }

    if (ctx.tableAlias() != null)
      node.$(TableSourceFields.Simple_Alias,
          MySQLAstHelper.stringifyIdentifier(ctx.tableAlias().identifier()));

    if (ctx.indexHintList() != null)
      node.$(TableSourceFields.Simple_Hints,
          mkNodes(map(ctx.indexHintList().indexHint(), this::visitIndexHint)));
  ...
  public SqlNode visitDerivedTable(MySQLParser.DerivedTableContext ctx)
  {
    ...
    if (ctx.LATERAL_SYMBOL() != null)
      node.flag(TableSourceFields.Derived_Lateral);

    node.$(TableSourceFields.Derived_Subquery, visitSubquery(ctx.subquery()));

    if (ctx.tableAlias() != null)
      node.$(TableSourceFields.Derived_Alias,
          MySQLAstHelper.stringifyIdentifier(ctx.tableAlias().identifier()));

    if (ctx.columnInternalRefList() != null)
    {
      final List<String> internalRefs = ctx.columnInternalRefList()
                                            .columnInternalRef()
                                            .stream()
  ...
  public SqlNode visitTableReference(MySQLParser.TableReferenceContext ctx)
  {
    ...
    if (joinedTables == null || joinedTables.isEmpty())
      return left;
    return joinedTables.stream().map(this::visitJoinedTable).reduce(left, (l, r) -> {
  ...
  public SqlNode visitJoinedTable(MySQLParser.JoinedTableContext ctx)
  {
    ...
    final JoinKind joinType = Commons.coalesce(MySQLAstHelper.parseJoinKind(ctx.innerJoinType()),
    ...
    if (ctx.expr() != null)
      node.$(TableSourceFields.Joined_On, toExpr(ctx.expr()));
    ...
    if (ctx.tableReference() != null)
      right = ctx.tableReference().accept(this);
    else if (ctx.tableFactor() != null)
      right = ctx.tableFactor().accept(this);
    else
      return assertFalse();
  ...
  public SqlNode visitIndexHint(MySQLParser.IndexHintContext ctx)
  {
    ...
    if (target != null)
      node.$(SqlNodeFields.IndexHint_Target, target);

    final var indexList = ctx.indexList();
    if (indexList != null)
    {
      node.$(SqlNodeFields.IndexHint_Names,
  ...
  public SqlNode visitSelectItem(MySQLParser.SelectItemContext ctx)
  {
    ...
    if (ctx.tableWild() != null)
      item.$(SqlNodeFields.SelectItem_Expr, visitTableWild(ctx.tableWild()));

    if (ctx.expr() != null)
      item.$(SqlNodeFields.SelectItem_Expr, toExpr(ctx.expr()));

    if (ctx.selectAlias() != null)
    {
      final var selectAlias = ctx.selectAlias();
      final String alias = selectAlias.identifier() != null
  ...
  public SqlNode visitExprIs(MySQLParser.ExprIsContext ctx)
  {
    ...
    if (ctx.IS_SYMBOL() == null)
      return left;

    final SqlNode right;
    if (ctx.UNKNOWN_SYMBOL() != null)
      right = mkLiteral(LiteralKind.UNKNOWN, null);
    else if (ctx.TRUE_SYMBOL() != null)
      right = mkLiteral(LiteralKind.BOOL, true);
    else if (ctx.FALSE_SYMBOL() != null)
      right = mkLiteral(LiteralKind.BOOL, false);
    else
      return assertFalse();
  ...
  {
    return mkBinary(ctx.boolPri().accept(this),
  ...
  {
    final SqlNode node = mkBinary(ctx.boolPri().accept(this),
        wrapAsQueryExpr(ctx.subquery().accept(this)),
        BinaryOpKind.ofOp(ctx.compOp().getText()));

    if (ctx.ALL_SYMBOL() != null)
      node.$(ExprFields.Binary_SubqueryOption, SubqueryOption.ALL);
    else if (ctx.ANY_SYMBOL() != null)
      node.$(ExprFields.Binary_SubqueryOption, SubqueryOption.ANY);
  ...
  public SqlNode visitBitExpr(MySQLParser.BitExprContext ctx)
  {
    if (ctx.simpleExpr() != null)
      return ctx.simpleExpr().accept(this);
    ...
    if (ctx.interval() != null)
    {
      ...
      right = ctx.bitExpr(1).accept(this);

    return mkBinary(ctx.bitExpr(0).accept(this),
        right,
        ctx.BITWISE_XOR_OPERATOR() != null ? BinaryOpKind.BITWISE_XOR
  ...
  public SqlNode visitWindowDefinition(MySQLParser.WindowDefinitionContext ctx)
  {
    ...
    if (ctx.windowName() != null)
      node.$(SqlNodeFields.WindowSpec_Alias,
          MySQLAstHelper.stringifyIdentifier(ctx.windowName().identifier()));
    return node;
  }
  ...
  public SqlNode visitWindowSpecDetails(MySQLParser.WindowSpecDetailsContext ctx)
  {
    ...
    if (ctx.windowName() != null)
      node.$(SqlNodeFields.WindowSpec_Name,
          MySQLAstHelper.stringifyIdentifier(ctx.windowName().identifier()));
    // partition by
    ...
    {
      final List<SqlNode> orderItems = ctx.orderList()
                                           .orderExpression()
                                           .stream()
  ...
  public SqlNode visitWindowFrameClause(MySQLParser.WindowFrameClauseContext ctx)
  {
    ...
    node.$(SqlNodeFields.WindowFrame_Unit,
    ...
    if (frameExclusion != null)
    {
      ...
      if (frameExclusion.CURRENT_SYMBOL() != null)
        exclusion = WindowExclusion.CURRENT_ROW;
      else if (frameExclusion.GROUP_SYMBOL() != null)
        exclusion = WindowExclusion.GROUP;
      else if (frameExclusion.TIES_SYMBOL() != null)
        exclusion = WindowExclusion.TIES;
      else if (frameExclusion.OTHERS_SYMBOL() != null)
        exclusion = WindowExclusion.NO_OTHERS;
      else
        return assertFalse();
    ...
    {
      node.$(
          SqlNodeFields.WindowFrame_Start, visitWindowFrameStart(frameExtent.windowFrameStart()));
    }
    else if (frameExtent.windowFrameBetween() != null)
    {
      final var frameBetween = frameExtent.windowFrameBetween();
      node.$(
          SqlNodeFields.WindowFrame_Start, visitWindowFrameBound(frameBetween.windowFrameBound(0)));
      node.$(
          SqlNodeFields.WindowFrame_End, visitWindowFrameBound(frameBetween.windowFrameBound(1)));
    }
    else
      return assertFalse();
  ...
  public SqlNode visitWindowFrameStart(MySQLParser.WindowFrameStartContext ctx)
  {
    ...
    if (ctx.PRECEDING_SYMBOL() != null)
    {
      ...
      if (ctx.UNBOUNDED_SYMBOL() != null)
        node.$(SqlNodeFields.FrameBound_Expr, mkSymbol("unbounded"));
      else if (ctx.PARAM_MARKER() != null)
        node.$(SqlNodeFields.FrameBound_Expr, mkParam());
      ...
      else if (ctx.INTERVAL_SYMBOL() != null)
      {
        final SqlNode interval =
            mkInterval(toExpr(ctx.expr()), MySQLAstHelper.parseIntervalUnit(ctx.interval()));
        node.$(SqlNodeFields.FrameBound_Expr, interval);
      }
    }
    else
      node.$(SqlNodeFields.FrameBound_Expr, mkSymbol("current row"));
  ...
  {
    if (ctx.windowFrameStart() != null)
      return visitWindowFrameStart(ctx.windowFrameStart());
  ...
  public SqlNode visitUlonglong_number(MySQLParser.Ulonglong_numberContext ctx)
  {
    ...
    final Token token = Commons
                            .coalesce(ctx.INT_NUMBER(),
                                ctx.LONG_NUMBER(),
  ...
  public SqlNode visitSimpleExprColumnRef(MySQLParser.SimpleExprColumnRefContext ctx)
  {
    ...
    else
    {
      ...
      final List<SqlNode> args = Arrays.asList(columnRef,
          mkLiteral(
              LiteralKind.TEXT, MySQLAstHelper.stringifyText(jsonOperator.textStringLiteral())));
      node.$(ExprFields.FuncCall_Name, mkName2(null, "json_extract"));
      node.$(ExprFields.FuncCall_Args, mkNodes(args));

      if (jsonOperator.JSON_UNQUOTED_SEPARATOR_SYMBOL() == null)
        return node;
      else
      {
  ...
  public SqlNode visitVariable(MySQLParser.VariableContext ctx)
  {
    ...
    if (ctx.userVariable() != null)
    {
      ...
      if (ctx.expr() != null)
        node.$(ExprFields.Variable_Assignment, toExpr(ctx.expr()));
    }
    else if (ctx.systemVariable() != null)
    {
      ...
      if (varIdentType == null)
        scope = VariableScope.SYSTEM_GLOBAL;
      else
      {
      ...
      if (systemVariable.dotIdentifier() != null)
        builder.append('.').append(
            MySQLAstHelper.stringifyIdentifier(systemVariable.dotIdentifier()));
  ...
  public SqlNode visitRuntimeFunctionCall(MySQLParser.RuntimeFunctionCallContext ctx)
  {
    ...
    if (ctx.name != null)
    {
      ...
      else if (ctx.INTERVAL_SYMBOL() != null)
      {
        ...
        final SqlNode interval =
            mkInterval(toExpr(ctx.expr(1)), MySQLAstHelper.parseIntervalUnit(ctx.interval()));
      ...
      else if (ctx.intervalTimeStamp() != null)
      {
        ...
        args = Arrays.asList(mkSymbol(ctx.intervalTimeStamp().getText().toLowerCase()),
            toExpr(ctx.expr(0)),
            toExpr(ctx.expr(1)));
      }
      else if (ctx.textLiteral() != null)
      {
        // OLD_PASSWORD
        args = singletonList(
            mkLiteral(LiteralKind.TEXT, MySQLAstHelper.stringifyText(ctx.textLiteral())));
      }
    ...
    else if (ctx.trimFunction() != null)
    {
      ...
      if (trimFunc.LEADING_SYMBOL() != null)
        args.add(mkSymbol("leading"));
      else if (trimFunc.TRAILING_SYMBOL() != null)
        args.add(mkSymbol("trailing"));
      else if (trimFunc.BOTH_SYMBOL() != null)
        args.add(mkSymbol("both"));
      else
        args.add(mkVoid());
  ...
  public SqlNode visitSimpleExprCollate(MySQLParser.SimpleExprCollateContext ctx)
  {
    ...
    node.$(ExprFields.Collate_Collation,
        mkSymbol(MySQLAstHelper.stringifyText(ctx.textOrIdentifier())));
  ...
  public SqlNode visitFunctionCall(MySQLParser.FunctionCallContext ctx)
  {
    ...
    {
      node.$(ExprFields.FuncCall_Name,
          mkName2(null, MySQLAstHelper.stringifyIdentifier(ctx.pureIdentifier()).toLowerCase()));

      if (ctx.udfExprList() != null)
        node.$(ExprFields.FuncCall_Args, mkNodes(toExprs(ctx.udfExprList())));
      else
        node.$(ExprFields.FuncCall_Args, mkNodes(emptyList()));
    }
    else if (ctx.qualifiedIdentifier() != null)
    {
      node.$(ExprFields.FuncCall_Name,
          mkName2(null,
              MySQLAstHelper.stringifyIdentifier(ctx.qualifiedIdentifier())[1].toLowerCase()));

      if (ctx.exprList() != null)
        node.$(ExprFields.FuncCall_Args, mkNodes(toExprs((ctx.exprList()))));
      else
        node.$(ExprFields.FuncCall_Args, mkNodes(emptyList()));
    }
    else
  ...
  public SqlNode visitLiteral(MySQLParser.LiteralContext ctx)
  {
    ...
    else if (ctx.temporalLiteral() != null)
    {
      ...
      unit = temporal.DATE_SYMBOL() != null     ? "date"
          : temporal.TIME_SYMBOL() != null      ? "time"
          : temporal.TIMESTAMP_SYMBOL() != null ? "timestamp"
                                                : null;
    }
  ...
  public SqlNode visitSumExpr(MySQLParser.SumExprContext ctx)
  {
    ...
    if (ctx.inSumExpr() != null)
      args = singletonList(visitInSumExpr(ctx.inSumExpr()));
    else if (ctx.exprList() != null)
      args = toExprs(ctx.exprList());
    else if (ctx.MULT_OPERATOR() != null)
      args = singletonList(mkWildcard(null));
    else
      args = emptyList();
    ...
    if (ctx.windowingClause() != null)
    {
      ...
      {
        node.$(ExprFields.Aggregate_WindowName,
            MySQLAstHelper.stringifyIdentifier(windowingClause.windowName().identifier()));
      }
      else if (windowingClause.windowSpec() != null)
      {
        node.$(ExprFields.Aggregate_WindowSpec,
    ...
    if (ctx.textString() != null)
      node.$(ExprFields.Aggregate_Sep, MySQLAstHelper.stringifyText(ctx.textString()));
  ...
  {
    final SqlNode node = mkExpr(ExprKind.Aggregate);
    if (ctx.ROW_NUMBER_SYMBOL() != null)
      node.$(ExprFields.Aggregate_Name, "ROW_NUMBER");
    else if (ctx.RANK_SYMBOL() != null)
      node.$(ExprFields.Aggregate_Name, "RANK");
    else if (ctx.DENSE_RANK_SYMBOL() != null)
      node.$(ExprFields.Aggregate_Name, "DENSE");
    else if (ctx.CUME_DIST_SYMBOL() != null)
      node.$(ExprFields.Aggregate_Name, "CUME");
    else if (ctx.PERCENT_RANK_SYMBOL() != null)
      node.$(ExprFields.Aggregate_Name, "PERNCENT_RANK");
    else if (ctx.NTILE_SYMBOL() != null)
      node.$(ExprFields.Aggregate_Name, "NTILE");
    else if (ctx.LEAD_SYMBOL() != null)
      node.$(ExprFields.Aggregate_Name, "LEAD");
    else if (ctx.LAG_SYMBOL() != null)
      node.$(ExprFields.Aggregate_Name, "LAG");
    else if (ctx.FIRST_VALUE_SYMBOL() != null)
      node.$(ExprFields.Aggregate_Name, "FIRST_VALUE");
    else if (ctx.LAST_VALUE_SYMBOL() != null)
      node.$(ExprFields.Aggregate_Name, "LAST_VALUE");
    else if (ctx.NTH_VALUE_SYMBOL() != null)
      node.$(ExprFields.Aggregate_Name, "NTH_VALUE");

    final var clause = ctx.windowingClause();
    if (clause.windowName() != null)
      node.$(ExprFields.Aggregate_WindowName,
          MySQLAstHelper.stringifyIdentifier(clause.windowName().identifier()));
  ...
  public SqlNode visitSimpleExprMatch(MySQLParser.SimpleExprMatchContext ctx)
  {
    ...
    final List<SqlNode> cols = map(ctx.identListArg().identList().simpleIdentifier(),
    ...
    if (fullTextOption != null)
    {
      ...
      else if (fullTextOption.EXPANSION_SYMBOL() != null && fullTextOption.NATURAL_SYMBOL() != null)
      {
  ...
  public SqlNode visitSimpleExprCase(MySQLParser.SimpleExprCaseContext ctx)
  {
    ...
    if (ctx.expr() != null)
      node.$(ExprFields.Case_Cond, toExpr(ctx.expr()));
    if (ctx.elseExpression() != null)
      node.$(ExprFields.Case_Else, toExpr(ctx.elseExpression().expr()));
  ...
  {
    final SqlNode interval =
        mkInterval(toExpr(ctx.expr(0)), MySQLAstHelper.parseIntervalUnit(ctx.interval()));
  ...
  {
    final String name;
    if (ctx.textOrIdentifier() != null)
      name = MySQLAstHelper.stringifyText(ctx.textOrIdentifier());
    else if (ctx.BINARY_SYMBOL() != null)
      name = "binary";
  ...
  private void parseFieldDefinition(MySQLParser.FieldDefinitionContext fieldDef, SqlNode node)
  {
    ...
    if (fieldDef.AS_SYMBOL() != null)
      node.flag(SqlNodeFields.ColDef_Generated);
  }
