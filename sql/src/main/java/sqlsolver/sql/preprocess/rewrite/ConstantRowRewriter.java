...
public class ConstantRowRewriter extends SqlNodePreprocess
{
  ...
  {
    if (node instanceof SqlSelect select && select.getFrom() == null && select.getWhere() == null
        && select.getGroup() == null && select.getHaving() == null && select.getFetch() == null
        && select.getOffset() == null && select.getWindowList().size() == 0)
    {
