...
public class OrEquationsRewriter extends RecursiveRewriter
{
  private SqlNode toOrNode(List<SqlNode> orList)
  {
    ...
    {
      orNode = SqlStdOperatorTable.OR.createCall(SqlParserPos.ZERO, orNode, orList.get(i));
    }
    return orNode;
  }
  ...
  {
    if (node instanceof SqlBasicCall call && call.getKind().equals(SqlKind.OR))
    {
