...
public class UnresolvedFunctionRewriter extends RecursiveRewriter
{
  ...
  private SqlNode handleSTRFTIME(SqlNode node)
  {
    if (node instanceof SqlBasicCall call
        && Objects.equals(call.getOperator().getName(), "STRFTIME"))
    {
      ...
      if (argument0 instanceof SqlCharStringLiteral charStringLiteral)
      {
        ...
        {
          intervalQualifier =
              new SqlIntervalQualifier(TimeUnit.YEAR, -1, null, -1, SqlParserPos.ZERO);
        }
      }
      if (argument0 instanceof SqlCharStringLiteral charStringLiteral)
      {
        ...
        {
          intervalQualifier =
              new SqlIntervalQualifier(TimeUnit.MONTH, -1, null, -1, SqlParserPos.ZERO);
        }
      }
      if (argument0 instanceof SqlCharStringLiteral charStringLiteral)
      {
        ...
        {
          intervalQualifier =
              new SqlIntervalQualifier(TimeUnit.DAY, -1, null, -1, SqlParserPos.ZERO);
        }
      }
  ...
  {
    if (node instanceof SqlBasicCall call
        && Objects.equals(call.getOperator().getName(), "POSITIVE"))
    {
