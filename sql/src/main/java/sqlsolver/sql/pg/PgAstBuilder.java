...
public class PgAstBuilder extends PGParserBaseVisitor<SqlNode> implements AstBuilderMixin
{
  ...
  public SqlNode visitConstraint_common(PGParser.Constraint_commonContext ctx)
  {
    ...
    if (ctx.identifier() != null)
      node.$(SqlNodeFields.IndexDef_Name, stringifyIdentifier(ctx.identifier()));
    ...
    if (bodyCtx.REFERENCES() != null)
    {
      ...
      ref.$(SqlNodeFields.Reference_Table,
          mkTableName(stringifyIdentifier(bodyCtx.schema_qualified_name())));
      if (bodyCtx.ref != null)
        ref.$(SqlNodeFields.Reference_Cols, mkColNames(bodyCtx.ref.names_references()));
    ...
    else if (bodyCtx.UNIQUE() != null || bodyCtx.PRIMARY() != null)
    {
      ...
      node.$(
          SqlNodeFields.IndexDef_Keys, mkKeyParts(bodyCtx.names_in_parens(0).names_references()));
    }
    else
      return null;
    ...
    if (actionCtxs != null)
      for (var actionCtx : actionCtxs)
        if (actionCtx.tabl_constraint != null)
        {
          ...
          if (constraint == null)
            actionCtx.tabl_constraint.accept(this);
  ...
  public SqlNode visitCreate_index_statement(PGParser.Create_index_statementContext ctx)
  {
    ...
    if (ctx.UNIQUE() != null)
      node.$(SqlNodeFields.IndexDef_Cons, UNIQUE);
    ...
    final List<SqlNode> keyParts =
        ListSupport.map((Iterable<PGParser.Sort_specifierContext>) restCtx.index_sort()
                            .sort_specifier_list()
                            .sort_specifier(),
  ...
  public SqlNode visitSelect_ops(PGParser.Select_opsContext ctx)
  {
    ...
    else
    {
      ...
      if (ctx.set_qualifier() != null)
        node.$(SqlNodeFields.SetOp_Option,
  ...
  public SqlNode visitSelect_ops_no_parens(PGParser.Select_ops_no_parensContext ctx)
  {
    if (ctx.select_ops() != null)
    {
      ...
      node.$(SqlNodeFields.SetOp_Right,
          wrapAsQuery(ctx.select_stmt() != null ? ctx.select_stmt().accept(this)
      ...
      final SetOpOption option = ctx.set_qualifier() == null
  ...
  public SqlNode visitSelect_primary(PGParser.Select_primaryContext ctx)
  {
    ...
    if (ctx.set_qualifier() != null && ctx.set_qualifier().DISTINCT() != null)
    {
      ...
      if (ctx.distinct != null)
        node.$(SqlNodeFields.QuerySpec_DistinctOn,
            mkNodes(ListSupport.map((Iterable<PGParser.VexContext>) ctx.distinct,
                (Function<? super PGParser.VexContext, ? extends SqlNode>) this::visitVex)));
    }

    if (ctx.select_list() != null)
      node.$(SqlNodeFields.QuerySpec_SelectItems,
          mkNodes(ListSupport.map(
              (Iterable<PGParser.Select_sublistContext>) ctx.select_list().select_sublist(),
              (Function<? super PGParser.Select_sublistContext, ?
                            extends SqlNode>) this::visitSelect_sublist)));
    ...
    if (ctx.where != null)
      node.$(SqlNodeFields.QuerySpec_Where, ctx.where.accept(this));
    if (ctx.having != null)
      node.$(SqlNodeFields.QuerySpec_Having, ctx.having.accept(this));

    if (ctx.groupby_clause() != null)
      node.$(SqlNodeFields.QuerySpec_GroupBy,
          mkNodes(ListSupport.map((Iterable<PGParser.Grouping_elementContext>) ctx.groupby_clause()
                                      .grouping_element_list()
                                      .grouping_element(),
              (Function<? super PGParser.Grouping_elementContext, ?
                            extends SqlNode>) this::visitGrouping_element)));
  ...
  public SqlNode visitFrom_item(PGParser.From_itemContext ctx)
  {
    if (ctx.LEFT_PAREN() != null)
      return ctx.from_item(0).accept(this);
    if (ctx.from_primary() != null)
      return ctx.from_primary().accept(this);
    ...
    if (ctx.vex() != null)
      node.$(TableSourceFields.Joined_On, ctx.vex().accept(this));
    // TODO: USING
  ...
  public SqlNode visitFrom_primary(PGParser.From_primaryContext ctx)
  {
    if (ctx.schema_qualified_name() != null)
    {
      ...
      node.$(TableSourceFields.Simple_Table,
          mkTableName(stringifyIdentifier(ctx.schema_qualified_name())));
      if (ctx.alias_clause() != null)
        node.$(TableSourceFields.Simple_Alias, parseAlias(ctx.alias_clause()));
      return node;
    }
    else if (ctx.table_subquery() != null)
    {
      ...
      if (ctx.alias_clause() != null)
        node.$(TableSourceFields.Derived_Alias, parseAlias(ctx.alias_clause()));
      return node;
    }
  ...
  public SqlNode visitSelect_sublist(PGParser.Select_sublistContext ctx)
  {
    ...
    if (ctx.col_label() != null)
      node.$(SqlNodeFields.SelectItem_Alias, stringifyIdentifier(ctx.col_label()));
    else if (ctx.id_token() != null)
      node.$(SqlNodeFields.SelectItem_Alias, stringifyIdentifier(ctx.id_token()));
  ...
  {
    if (ctx.vex() != null)
      return mkGroupItem(ctx.vex().accept(this));
    else
      return null; // TODO
  }
  ...
  public SqlNode visitVex(PGParser.VexContext ctx)
  {
    ...
    else if (ctx.collate_identifier() != null)
    {
      ...
      node.$(ExprFields.Collate_Collation,
          mkName3(stringifyIdentifier(ctx.collate_identifier().collation)));
      return node;
    }
    ...
    else if (ctx.binary_operator != null)
    {
      ...
      final SqlNode node = mkBinary(
          left, right, ctx.EXP() != null ? EXP : BinaryOpKind.ofOp(ctx.binary_operator.getText()));
    ...
    else if (ctx.IN() != null)
    {
      ...
      else
      {
        ...
        tuple.$(ExprFields.Tuple_Exprs,
            mkNodes(ListSupport.map((Iterable<PGParser.VexContext>) vexs.subList(1, vexs.size()),
                (Function<? super PGParser.VexContext, ? extends SqlNode>) this::visitVex)));
    ...
    else if (ctx.IS() != null)
    {
      ...
      if (ctx.truth_value() != null)
        right = mkLiteral(LiteralKind.BOOL, parseTruthValue(ctx.truth_value()));
      else if (ctx.NULL() != null)
        right = mkLiteral(LiteralKind.NULL, null);
      else if (ctx.DOCUMENT() != null)
        right = mkSymbol("DOCUMENT");
      else if (ctx.UNKNOWN() != null)
        right = mkLiteral(LiteralKind.UNKNOWN, null);
      else if (ctx.vex(1) != null)
        right = ctx.vex(1).accept(this);
      // TODO: IS OF
      else
        return assertFalse();
    ...
    else if (ctx.op() != null)
    {
      ...
      if (opCtx.OPERATOR() != null)
        return null; // TODO: custom operator
      ...
      else
      {
        ...
        return op != ARRAY_CONTAINED_BY ? mkBinary(left, right, op)
    ...
    else if (ctx.vex().size() >= 1)
    {
      final SqlNode tuple = mkExpr(ExprKind.Tuple);
      tuple.$(ExprFields.Tuple_Exprs,
          mkNodes(ListSupport.map((Iterable<PGParser.VexContext>) ctx.vex(),
              (Function<? super PGParser.VexContext, ? extends SqlNode>) this::visitVex)));
      return tuple;
    }
    else
  ...
  public SqlNode visitVex_b(PGParser.Vex_bContext ctx)
  {
    ...
    else if (ctx.IS() != null)
    {
      ...
      if (ctx.DOCUMENT() != null)
        ...
        right = mkLiteral(LiteralKind.UNKNOWN, null);
      else if (ctx.vex_b(1) != null)
        right = ctx.vex_b(1).accept(this);
  ...
  public SqlNode visitValue_expression_primary(PGParser.Value_expression_primaryContext ctx)
  {
    if (ctx.unsigned_value_specification() != null)
      ...
      return mkLiteral(LiteralKind.NULL, null);
    else if (ctx.MULTIPLY() != null)
      return mkWildcard(null);
  ...
  public SqlNode visitIndirection_var(PGParser.Indirection_varContext ctx)
  {
    ...
    else if (ctx.identifier() != null)
    {
      ...
      if (ctx.indirection_list() == null)
        return mkColRef(null, null, identifier);
      else
      {
        final SqlNodes indirections = parseIndirectionList(ctx.indirection_list());
  ...
  public SqlNode visitIndirection(PGParser.IndirectionContext ctx)
  {
    ...
    else if (ctx.COLON() != null)
    {
      ...
      if (start != null)
        node.$(ExprFields.IndirectionComp_Start, start.accept(this));
      if (end != null)
        node.$(ExprFields.IndirectionComp_End, end.accept(this));
  ...
  public SqlNode visitCase_expression(PGParser.Case_expressionContext ctx)
  {
    ...
    if (ctx.condition != null)
      _case.$(ExprFields.Case_Cond, ctx.condition.accept(this));
    if (ctx.otherwise != null)
      _case.$(ExprFields.Case_Else, ctx.otherwise.accept(this));
  ...
  public SqlNode visitComparison_mod(PGParser.Comparison_modContext ctx)
  {
    ...
    if (ctx.ALL() != null)
      option = SubqueryOption.ALL;
    else if (ctx.ANY() != null)
      option = SubqueryOption.ANY;
    else if (ctx.SOME() != null)
      option = SubqueryOption.SOME;
    else
      option = null;

    node.$(ExprFields.ComparisonMod_Option, option);
    if (ctx.vex() != null)
      node.$(ExprFields.ComparisonMod_Expr, ctx.vex().accept(this));
    else if (ctx.select_stmt_no_parens() != null)
      node.$(
          ExprFields.ComparisonMod_Expr, wrapAsQueryExpr(ctx.select_stmt_no_parens().accept(this)));
  ...
  public SqlNode visitArray_expression(PGParser.Array_expressionContext ctx)
  {
    if (ctx.array_elements() != null)
      return ctx.array_elements().accept(this);
    else if (ctx.table_subquery() != null)
    {
  ...
  public SqlNode visitArray_elements(PGParser.Array_elementsContext ctx)
  {
    ...
    final List<SqlNode> elements =
        ListSupport.map((Iterable<PGParser.Array_elementContext>) ctx.array_element(),
            (Function<? super PGParser.Array_elementContext, ?
                          extends SqlNode>) this::visitArray_element);
  ...
  {
    if (ctx.vex() != null)
      return ctx.vex().accept(this);
    else if (ctx.array_elements() != null)
      return ctx.array_elements().accept(this);
    else
      return assertFalse();
  }
  ...
  public SqlNode visitWindow_definition(PGParser.Window_definitionContext ctx)
  {
    ...
    if (ctx.identifier() != null)
      node.$(SqlNodeFields.WindowSpec_Name, stringifyIdentifier(ctx.identifier()));
    if (ctx.partition_by_columns() != null)
      node.$(SqlNodeFields.WindowSpec_Part,
          mkNodes(ListSupport.map((Iterable<PGParser.VexContext>) ctx.partition_by_columns().vex(),
              (Function<? super PGParser.VexContext, ? extends SqlNode>) this::visitVex)));
    if (ctx.orderby_clause() != null)
      node.$(SqlNodeFields.WindowSpec_Order, toOrderItems(ctx.orderby_clause()));
    if (ctx.frame_clause() != null)
      node.$(SqlNodeFields.WindowSpec_Frame, ctx.frame_clause().accept(this));
  ...
  public SqlNode visitFrame_clause(PGParser.Frame_clauseContext ctx)
  {
    ...
    if (ctx.RANGE() != null)
      node.$(SqlNodeFields.WindowFrame_Unit, WindowUnit.RANGE);
    else if (ctx.ROWS() != null)
      node.$(SqlNodeFields.WindowFrame_Unit, WindowUnit.ROWS);
    else if (ctx.GROUPS() != null)
      node.$(SqlNodeFields.WindowFrame_Unit, WindowUnit.GROUPS);

    node.$(SqlNodeFields.WindowFrame_Start, ctx.frame_bound(0).accept(this));
    if (ctx.BETWEEN() != null)
      node.$(SqlNodeFields.WindowFrame_End, ctx.frame_bound(1).accept(this));

    if (ctx.EXCLUDE() != null)
    {
      if (ctx.CURRENT() != null)
        node.$(SqlNodeFields.WindowFrame_Exclusion, WindowExclusion.CURRENT_ROW);
      else if (ctx.GROUP() != null)
        node.$(SqlNodeFields.WindowFrame_Exclusion, WindowExclusion.GROUP);
      else if (ctx.TIES() != null)
        node.$(SqlNodeFields.WindowFrame_Exclusion, WindowExclusion.TIES);
      else if (ctx.OTHERS() != null)
        node.$(SqlNodeFields.WindowFrame_Exclusion, WindowExclusion.NO_OTHERS);
    }
  ...
  public SqlNode visitFrame_bound(PGParser.Frame_boundContext ctx)
  {
    ...
    else if (ctx.vex() != null)
      node.$(SqlNodeFields.FrameBound_Expr, ctx.vex().accept(this));
  ...
  private void addConstraint(SqlNode node, PGParser.Constr_bodyContext ctx)
  {
    if (ctx.CHECK() != null)
      ...
      node.flag(SqlNodeFields.ColDef_Cons, ConstraintKind.NOT_NULL);
    else if (ctx.UNIQUE() != null)
      node.flag(SqlNodeFields.ColDef_Cons, UNIQUE);
    else if (ctx.PRIMARY() != null)
      node.flag(SqlNodeFields.ColDef_Cons, PRIMARY);
    else if (ctx.DEFAULT() != null)
      node.flag(SqlNodeFields.ColDef_Default);
    else if (ctx.GENERATED() != null)
      node.flag(SqlNodeFields.ColDef_Generated);
    else if (ctx.identity_body() != null)
      node.flag(SqlNodeFields.ColDef_AutoInc);
    else if (ctx.REFERENCES() != null)
    {
      ...
      ref.$(SqlNodeFields.Reference_Table,
          mkTableName(stringifyIdentifier(ctx.schema_qualified_name())));
      if (ctx.ref != null)
        ref.$(SqlNodeFields.Reference_Cols, mkColNames(ctx.ref.names_references()));
  ...
  private void addAfterOp(SqlNode node, PGParser.After_opsContext ctx)
  {
    if (ctx.LIMIT() != null && ctx.ALL() == null)
      node.$(SqlNodeFields.Query_Limit, ctx.vex().accept(this));
    else if (ctx.FETCH() != null)
      node.$(SqlNodeFields.Query_Limit,
          ctx.vex() != null ? ctx.vex().accept(this) : mkLiteral(LiteralKind.INTEGER, 1));
    else if (ctx.OFFSET() != null)
      node.$(SqlNodeFields.Query_Offset, ctx.vex().accept(this));
  ...
  private SqlNode toKeyPart(PGParser.Sort_specifierContext ctx)
  {
    ...
    if (ExprKind.ColRef.isInstance(expr))
      node.$(SqlNodeFields.KeyPart_Col,
          expr.$(ExprFields.ColRef_ColName).$(SqlNodeFields.ColName_Col));
    else
      node.$(SqlNodeFields.KeyPart_Expr, expr);

    if (ctx.order != null)
    {
      final String direction = ctx.order.getText().toLowerCase();
      if ("asc".equals(direction))
        node.$(SqlNodeFields.KeyPart_Direction, KeyDirection.ASC);
      else if ("desc".equals(direction))
        node.$(SqlNodeFields.KeyPart_Direction, KeyDirection.DESC);
      // TODO: USING
    }
  ...
  private SqlNode toOrderItem(PGParser.Sort_specifierContext ctx)
  {
    ...
    if (ctx.order != null)
    {
      final String direction = ctx.order.getText().toLowerCase();
      if ("asc".equals(direction))
        node.$(SqlNodeFields.OrderItem_Direction, KeyDirection.ASC);
      else if ("desc".equals(direction))
        node.$(SqlNodeFields.OrderItem_Direction, KeyDirection.DESC);
      // TODO: USING
    }
  ...
  {
    return mkNodes(ListSupport.map(
        (Iterable<PGParser.Sort_specifierContext>) ctx.sort_specifier_list().sort_specifier(),
        (Function<? super PGParser.Sort_specifierContext, ? extends SqlNode>) this::toOrderItem));
  }
  ...
  private SqlNode parseFuncCall(PGParser.Function_callContext ctx, String[] name)
  {
    ...
    if (name != null)
    {
      ...
      node.$(ExprFields.FuncCall_Args,
          mkNodes(ListSupport.map(
              (Iterable<PGParser.Vex_or_named_notationContext>) ctx.vex_or_named_notation(),
              (Function<? super PGParser.Vex_or_named_notationContext, ?
                            extends SqlNode>) this::visitVex_or_named_notation)));
      return node;
    }
    else if (ctx.function_construct() != null)
    {
      ...
      if (funcConstructCtx.funcName != null)
      {
        ...
        node.$(ExprFields.FuncCall_Args,
            mkNodes(ListSupport.map((Iterable<PGParser.VexContext>) funcConstructCtx.vex(),
                (Function<? super PGParser.VexContext, ? extends SqlNode>) this::visitVex)));
        return node;
      }
      else if (funcConstructCtx.ROW() != null)
      {
        ...
        tupleNode.$(ExprFields.Tuple_Exprs,
            mkNodes(ListSupport.map((Iterable<PGParser.VexContext>) funcConstructCtx.vex(),
                (Function<? super PGParser.VexContext, ? extends SqlNode>) this::visitVex)));
    ...
    else if (ctx.extract_function() != null)
    {
      ...
      final SqlNode firstArg = mkSymbol(coalesce(stringifyIdentifier(extractFuncCtx.identifier()),
    ...
    else if (ctx.date_time_function() != null)
    {
      ...
      if (dateTimeFuncCtx.type_length() != null)
        node.$(ExprFields.FuncCall_Args,
            mkNodes(singletonList(
                mkLiteral(LiteralKind.INTEGER, typeLength2Int(dateTimeFuncCtx.type_length())))));
      else
        node.$(ExprFields.FuncCall_Args, mkNodes(Collections.emptyList()));
    ...
    else if (ctx.string_value_function() != null)
    {
      ...
      {
        node.$(ExprFields.FuncCall_Args,
            mkNodes(Arrays.asList(
                strValueFuncCtx.vex_b().accept(this), strValueFuncCtx.vex(0).accept(this))));
      }
      else
        node.$(ExprFields.FuncCall_Args,
            mkNodes(ListSupport.map((Iterable<PGParser.VexContext>) strValueFuncCtx.vex(),
                (Function<? super PGParser.VexContext, ? extends SqlNode>) this::visitVex)));
  ...
  private SqlNode parseAggregate(PGParser.Function_callContext ctx, String[] name)
  {
    ...
    if (argsCtx != null)
    {
      ...
      for (final var argCtx : argsCtx)
      {
        ...
        if (argCtx.VARIADIC() != null)
          argNode.flag(SqlNodeFields.Expr_FuncArgVariadic);
        if (argCtx.argname != null)
          argNode.$(SqlNodeFields.Expr_ArgName, stringifyIdentifier(argCtx.argname));
      }

      node.$(ExprFields.Aggregate_Args, mkNodes(argExprs));
    }
    else
      node.$(ExprFields.Aggregate_Args, mkNodes(Collections.emptyList()));

    if (ctx.order0 != null)
      node.$(ExprFields.Aggregate_Order, toOrderItems(ctx.order0));

    if (ctx.order1 != null)
      node.$(ExprFields.Aggregate_WithinGroupOrder, toOrderItems(ctx.order1));
  ...
  {
    final List<SqlNode> nodes = ctx.schema_qualified_name()
                                    .stream()
  ...
  private SqlNode parseUnsignedLiteral(PGParser.Unsigned_value_specificationContext ctx)
  {
    ...
    if (value instanceof Boolean)
      return mkLiteral(LiteralKind.BOOL, value);
    else if (value instanceof Double)
      return mkLiteral(LiteralKind.FRACTIONAL, value);
    else if (value instanceof Long)
      return (Long) value <= Integer.MAX_VALUE ? mkLiteral(LiteralKind.INTEGER, value)
                                               : mkLiteral(LiteralKind.LONG, value);
    else if (value instanceof String)
      return mkLiteral(LiteralKind.TEXT, value);
    else
      return assertFalse();
  }
  ...
  private SqlNode buildIndirection(String id, List<SqlNode> indirections)
  {
    ...
    return ExprKind.ColRef.isInstance(header)
        ...
        : mkIndirection(header.$(ExprFields.Indirection_Expr),
              mkNodes(header.$(ExprFields.Indirection_Comps).size() == 2
                      ? indirections
  ...
  private SqlNode buildIndirection1(String id, SqlNode indirection)
  {
    if (!indirection.isFlag(ExprFields.IndirectionComp_Subscript))
    {
      ...
      if (ExprKind.Symbol.isInstance(indirectionExpr))
        ...
        return mkWildcard(mkTableName(null, id));
    }
  ...
  private SqlNode buildIndirection2(String id, SqlNode _0, SqlNode _1)
  {
    ...
    if (ExprKind.Symbol.isInstance(expr1))
      return mkColRef(id, expr0.$(ExprFields.Symbol_Text), expr1.$(ExprFields.Symbol_Text));
    else if (ExprKind.Wildcard.isInstance(expr1))
      return mkWildcard(mkTableName(null, expr0.$(ExprFields.Symbol_Text)));
    else
      return mkIndirection(
          mkColRef(null, id, expr0.$(ExprFields.Symbol_Text)), mkNodes(singletonList(_1)));
  }

  private SqlNodes parseIndirectionList(PGParser.Indirection_listContext ctx)
  {
    final List<SqlNode> indirections = ListSupport.map(
        (Iterable<PGParser.IndirectionContext>) ctx.indirection(),
        (Function<? super PGParser.IndirectionContext, ? extends SqlNode>) this::visitIndirection);
