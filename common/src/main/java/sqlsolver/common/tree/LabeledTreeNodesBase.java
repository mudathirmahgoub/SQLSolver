...
public abstract class LabeledTreeNodesBase<Kind, C extends LabeledTreeContext<Kind>, N
                                               extends LabeledTreeNode<Kind, C, N>>
    extends AbstractList<N> implements LabeledTreeNodes<Kind, C, N>
{
  ...
  public boolean erase(int nodeId)
  {
    if (nodeIds.remove(nodeId))
    {
      ...
      if (parentId != TreeContext.NO_SUCH_NODE
          && context.parentOf(nodeId) != TreeContext.NO_SUCH_NODE)
  ...
  public boolean add(N n)
  {
    ...
    if (parentId != TreeContext.NO_SUCH_NODE)
      context.setParentOf(n.nodeId(), parentId);
    return true;
  }
  ...
  {
    if (!(o instanceof LabeledTreeNode))
      return false;
