...
public interface Commons
{
  ...
  static <T> String joining(String headOrPrefix,
      String sep,
      String tailOrSuffix,
      boolean asFixture,
      Iterable<T> objs,
  ...
  static <T> String joining(String head,
      String prefix,
      String sep,
      String suffix,
      String tail,
  ...
  static StringBuilder joining(String headOrPrefix,
      String sep,
      String tailOrSuffix,
      boolean asFixture,
      Iterable<?> objs,
  ...
  static <T> StringBuilder joining(String headOrPrefix,
      String sep,
      String tailOrSuffix,
      boolean asFixture,
      Iterable<T> objs,
  ...
  {
    if (asFixture)
      return joining("", headOrPrefix, sep, tailOrSuffix, "", objs, dest, func);
    else
      return joining(headOrPrefix, "", sep, "", tailOrSuffix, objs, dest, func);
  }

  static StringBuilder joining(String head,
      String prefix,
      String sep,
      String suffix,
      String tail,
  ...
  static <T> StringBuilder joining(String head,
      String prefix,
      String sep,
      String suffix,
      String tail,
