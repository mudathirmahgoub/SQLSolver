...
public interface QueryPair
{
  ...
  static QueryPair mk(
      int lineNum, Schema schema, String sql0, String sql1, String originSql0, String originSql1)
  {
    return new QueryPairImpl(
        lineNum, schema, sql0, sql1, originSql0, originSql1, null, null, null, null);
  }
  ...
  static QueryPair mk(int lineNum,
      Schema schema,
      String sql0,
      String sql1,
      String originSql0,
  ...
  {
    return new QueryPairImpl(
        lineNum, schema, sql0, sql1, originSql0, originSql1, q0, q1, null, null);
  }
