...
public class SqlSolverTest
{
  ...
  private final LiaStar a = LiaStar.mkVar(false, "a", Value.TYPE_INT);
  private final LiaStar b = LiaStar.mkVar(false, "b", Value.TYPE_INT);
  ...
  private final LiaStar c4 = LiaStar.mkConst(false, 4);
