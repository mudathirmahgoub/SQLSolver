...
(assert (and (not (= (ite (= u3 1000) (ite (= u3 2000) (+ u1 u0) u0) (ite (= u3 2000) u1 0)) (ite (< 0 u4) u2 0))) (int.star-contains (lambda ((u6 Int) (u9 Int) (u10 Int) (u7 Int) (u8 Int) (u3 Int) ) (and (and (= u6 (ite (= 1000 u7) u8 0)) (= u9 (ite (= u3 u7) u8 0))) (= u10 (ite (= 2000 u7) u8 0)))) u0 u2 u1 sumFresh0 sumFresh1 sumFresh2 )))
(check-sat)
