...
(assert (and (not (= (ite (= u3 (+ u0 u1)) 1 0) (ite (= u3 u2) 1 0))) (int.star-contains (lambda ((u5 Int) (u8 Int) (u10 Int) (u6 Int) (u7 Int) (u9 Int) ) (and (and (= u5 (ite (= u7 10) u6 0)) (= u8 (ite (< 0 u9) u6 0))) (= u10 (ite (= u7 30) u6 0)))) u1 u2 u0 sumFresh0 sumFresh1 sumFresh2 )))
(check-sat)
