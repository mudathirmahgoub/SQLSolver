...
(assert (and (not (= (ite (and (and (not (= u0 0)) (= u5 u1)) (= u4 u6)) 1 0) (ite (and (and (= u4 u6) (not (= u2 0))) (= u5 u3)) 1 0))) (int.star-contains (lambda ((u8 Int) (u11 Int) (u12 Int) (u13 Int) (u9 Int) (u10 Int) (u6 Int) (u4 Int) ) (and (and (and (= u8 (ite (and (and (= u9 u6) (= u4 u9)) (not (= u10 0))) 1 0)) (= u11 (ite (and (= u4 u9) (not (= u10 0))) 1 0))) (= u12 (ite (= u6 u9) u10 0))) (= u13 (ite (= u4 u9) u10 0)))) u3 u1 u2 u0 sumFresh0 sumFresh1 sumFresh2 sumFresh3 )))
(check-sat)
