...
public class FragmentSupport
{
  ...
  static
  {
    ...
    //        map(List.of(AGG, AGG, INNER_JOIN, LEFT_JOIN, SIMPLE_FILTER, PROJ, PROJ, IN_SUB_FILTER,
    //        UNION, UNION), Op::mk); map(List.of(AGG, AGG, AGG, AGG, AGG, AGG, INNER_JOIN,
    //        LEFT_JOIN, SIMPLE_FILTER, PROJ, PROJ, IN_SUB_FILTER, UNION, UNION), Op::mk);
    BASIC_PRUNING_RULES = Set.of(new MalformedJoin(),
    ...
    //            new MalformedSubquery(),
    //            new NonLeftDeepJoin(),
    //            // There are some hard-coded optimization in Rewriter (TopDownOptimizer). Some
    //            rules
