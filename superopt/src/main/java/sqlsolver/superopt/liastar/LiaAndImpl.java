...
public class LiaAndImpl extends LiaStar
{
  ...
  protected void prettyPrint(PrettyBuilder builder)
  {
    ...
    prettyPrintBinaryOp(builder, operand1, operand2, needsParen1, needsParen2, true, " /\\ ");
  }
  ...
  public LiaStar expandStar()
  {
    ...
    LiaStar g = mkConjunction(innerStar, nonStars.stream().map(LiaStar::expandStar).toList());
    if (stars.isEmpty())
    {
      return g;
    }
  ...
  public EstimateResult estimate()
  {
    ...
    return new EstimateResult(r1.vars, r1.n_extra + r2.n_extra, r1.m + r2.m, Math.max(r1.a, r2.a));
  }

  @Override
  public Expr expandStarWithK(Context ctx, Solver sol, String suffix)
  {
    return ctx.mkAnd((BoolExpr) operand1.expandStarWithK(ctx, sol, suffix),
