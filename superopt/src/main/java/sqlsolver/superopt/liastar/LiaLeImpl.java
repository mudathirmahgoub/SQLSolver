...
public class LiaLeImpl extends LiaStar
{
  ...
  {
    prettyPrintBinaryOp(builder, operand1, operand2, false, false, " <= ");
  }
  ...
  public EstimateResult estimate()
  {
    ...
    return new EstimateResult(
        r1.vars, r1.n_extra + r2.n_extra + 1, r1.m + r2.m + 1, Math.max(r1.a, r2.a));
  }

  @Override
  public Expr expandStarWithK(Context ctx, Solver sol, String suffix)
  {
    return ctx.mkLe((ArithExpr) operand1.expandStarWithK(ctx, sol, suffix),
      ...
      BiFunction<LiaStar, LiaStar, LiaStar> transformer, LiaStar parent)
  {
    ...
    return transformer.apply(mkLe(innerStar, operand10, operand20), parent);
  }
      ...
      BiFunction<LiaStar, LiaStar, LiaStar> transformer, LiaStar parent)
  {
    ...
    return mkLe(innerStar, operand10, operand20);
  }
