...
public abstract class LiaStar
{
  ...
  public abstract Expr transToSMT(
      Context ctx, Map<String, Expr> varsName, Map<String, FuncDecl> funcsName);
  ...
  public static LiaSumImpl mkSum(
      boolean isInnerStar, List<String> outerVector, List<String> innerVector, LiaStar constraint)
  {
  ...
  public static LiaFuncImpl mkFunc(
      boolean isInnerStar, String funcName, LiaStar var, boolean allowsUndefined)
  {
  ...
  public static LiaFuncImpl mkFunc(
      boolean isInnerStar, String funcName, List<LiaStar> vars, boolean allowsUndefined)
  {
...
//        return or;
      ...
      case LAND -> {
        ...
        newLia = mkOr(
            innerStar, mkAnd(innerStar, other, or.operand1), mkAnd(innerStar, other, or.operand2));
    }
    if (newLia != null)
      return paramLiaStar2DNF(newLia, activated);
  }
...
//        eq.operand2 = paramLiaStar2DNF(eq.operand2, activated);
        ...
        final LiaAndImpl and1 =
            (LiaAndImpl) mkAnd(innerStar, ite.cond, mkEq(innerStar, other, ite.operand1));
        final LiaAndImpl and2 = (LiaAndImpl) mkAnd(
            innerStar, mkNot(innerStar, ite.cond), mkEq(innerStar, other, ite.operand2));
...
//        le.operand2 = paramLiaStar2DNF(le.operand2, activated);
        ...
        final LiaAndImpl and1 =
            (LiaAndImpl) mkAnd(innerStar, ite.cond, mkLe(innerStar, other, ite.operand1));
        final LiaAndImpl and2 = (LiaAndImpl) mkAnd(
            innerStar, mkNot(innerStar, ite.cond), mkLe(innerStar, other, ite.operand2));
        final LiaStar or = mkOr(innerStar, and1, and2);
        return paramLiaStar2DNF(or, activated);
        }
...
//        lt.operand2 = paramLiaStar2DNF(lt.operand2, activated);
        ...
        final LiaAndImpl and1 =
            (LiaAndImpl) mkAnd(innerStar, ite.cond, mkLt(innerStar, other, ite.operand1));
        final LiaAndImpl and2 = (LiaAndImpl) mkAnd(
            innerStar, mkNot(innerStar, ite.cond), mkLt(innerStar, other, ite.operand2));
        final LiaStar or = mkOr(innerStar, and1, and2);
        return paramLiaStar2DNF(or, activated);
        }
  ...
  public static LiaStar simplifyConj(LiaStar formula) {
    ...
    for(LiaStar lit : literals)
        ...
        return (result == null) ? mkConst(formula.innerStar, 1) : result;
          ...
          public static LiaStar simplifyDNF(LiaStar formula)
          {
            ...
            for (LiaStar conj : conjunctions)
            {
              ...
              {
                return mkEq(formula.innerStar,
                    mkConst(formula.innerStar, 0),
                    mkConst(formula.innerStar, 0));
              }
              else if (simpleConj != null)
              {
                result =
                    (result == null) ? simpleConj : mkOr(formula.innerStar, result, simpleConj);
              }
            }
            return (result == null) ? mkEq(formula.innerStar,
                                          mkConst(formula.innerStar, 0),
                                          mkConst(formula.innerStar, 1))
                                    : result;
          }
          ...
          public static LiaStar replaceVars(
              LiaStar formula, Set<String> vars, Map<String, String> replacementMap)
          {
            if (formula == null)
            {
              return null;
          ...
          public static LiaStar mkConjunction(boolean innerStar, List<LiaStar> conjs)
          {
            ...
            for (LiaStar lit : conjs)
            {
              ...
              {
                result =
                    (result == null) ? lit.deepcopy() : mkAnd(innerStar, result, lit.deepcopy());
              }
            }
            if (result == null)
            {
          ...
          public static LiaStar mkDisjunction(boolean innerStar, List<LiaStar> disjs)
          {
            ...
            for (LiaStar lit : disjs)
            {
              ...
              {
                result =
                    (result == null) ? lit.deepcopy() : mkOr(innerStar, result, lit.deepcopy());
              }
            }
            if (result == null)
            {
          ...
          public static LiaStar innerVarEqOuterVar(
              List<String> outerVector, List<String> innerVector)
          {
            LiaStar result = null;
          ...
          public static LiaStar expandStarWithUnderapp(LiaStar formula, int m)
          {
            switch (formula.getType())
            {
              ...
              case LOR:
              {
                ...
                return mkOr(false,
                    expandStarWithUnderapp(orLia.operand1, m),
                    expandStarWithUnderapp(orLia.operand2, m));
              }
              case LAND:
              {
                LiaAndImpl andLia = (LiaAndImpl) formula;
                return mkAnd(false,
                    expandStarWithUnderapp(andLia.operand1, m),
                    expandStarWithUnderapp(andLia.operand2, m));
              }
              case LSUM:
              {
          ...
          public static LiaStar replaceFreeAndBoundVars(
              LiaStar formula, Map<String, String> oldToNewVars)
          {
            if (formula == null)
            {
              return formula;
      ...
      case LSUM -> {
        ...
        return LiaStar.mkSum(formula.innerStar,
            newOuterVars,
            newInnerVars,
            replaceFreeAndBoundVars(sum.constraints, oldToNewVars));
            }
            default ->
            {
              return formula;
         ...
         */
        protected abstract LiaStar transformPostOrder(
        ...
        protected abstract LiaStar transformPreOrderRecursive(
            BiFunction<LiaStar, LiaStar, LiaStar> transformer, LiaStar parent);
        ...
        protected static void prettyPrintBinaryOp(PrettyBuilder builder,
            ...
            String op)
        {
          prettyPrintBinaryOp(builder, operand1, operand2, needsParen1, needsParen2, false, op);
        }
        ...
        public static LiaStar eqNVectors(
            boolean innerStar, List<String> leftVector, List<List<String>> rightVectors)
        {
          LiaStar result = null;
          for (int i = 0; i < leftVector.size(); ++i)
          {
            ...
            for (int j = 0; j < rightVectors.size(); ++j)
            {
              ...
              rightPlusFormula = (rightPlusFormula == null)
                  ? rightVar
                  : mkPlus(innerStar, rightPlusFormula, rightVar);
            }
        ...
        public static LiaStar spanLiastarByNVectors(LiaStar formula, int n)
        {
          switch (formula.getType())
          {
            ...
            case LSUM:
            {
              ...
              LiaStar outerEqSumOfNVectors =
                  eqNVectors(sumFormula.innerStar, sumFormula.outerVector, newNameVectors);
              ...
              for (int i = 0; i < n; ++i)
              {
                ...
                newLiasumFormulas = (newLiasumFormulas == null)
                    ? tmpSumFormula
                    : mkAnd(sumFormula.innerStar, newLiasumFormulas, tmpSumFormula);
              }
