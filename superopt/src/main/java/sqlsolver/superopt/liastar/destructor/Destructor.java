...
public abstract class Destructor
{
   ...
   */
  public static List<LiaStar> destruct(
      LiaStar formula, Set<String> params, Set<String> importantVars)
  {
  ...
  protected void classifyConjunctionLiteralsByParam(
      LiaStar formula, List<LiaStar> noParamPart, List<LiaStar> paramPart)
  {
