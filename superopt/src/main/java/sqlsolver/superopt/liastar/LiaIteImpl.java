...
public class LiaIteImpl extends LiaStar
{
  ...
  {
    return cond.isPrettyPrintMultiLine() || operand1.isPrettyPrintMultiLine()
  ...
  {
    if (operand1.getType().equals(LiaOpType.LCONST) && operand2.getType().equals(LiaOpType.LCONST))
    {
  ...
  public EstimateResult estimate()
  {
    ...
    return new EstimateResult(rc.vars,
  ...
  {
    return ctx.mkITE((BoolExpr) cond.expandStarWithK(ctx, sol, suffix),
