...
final public class UFuncImpl implements UFunc
{
  ...
  public boolean groupSimilarVariables(UTerm that, SetMatching<String> matching)
  {
    ...
    {
      int size = arguments.size();
      if (funcKind != func.funcKind() || !Objects.equals(funcName, func.funcName())
          || size != func.args().size())
        return false;
  ...
  public boolean equals(Object obj)
  {
    if (this == obj)
      return true;
    if (!(obj instanceof UFunc))
      return false;

    UFunc that = (UFunc) obj;
    if (funcKind != that.funcKind() || !funcName.equals(that.funcName()))
      return false;
    if (arguments.size() != that.args().size())
      return false;
  ...
  public int hashCode()
  {
    return funcKind.hashCode() * 31 * 31 + funcName.hashCode() * 31
