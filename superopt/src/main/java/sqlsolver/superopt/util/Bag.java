...
public class Bag<T> implements Collection<T>
{
  ...
  public boolean add(T e, int count)
  {
    if (countMap.containsKey(e))
      countMap.compute(e, (k, v) -> v + count);
    else
  ...
  public <T1> T1[] toArray(@NotNull T1[] a)
  {
    ...
    if (a.length >= requiredSize)
      target = a;
    else
      target = (T1[]) Array.newInstance(a.getClass(), requiredSize);
    int index = 0;
